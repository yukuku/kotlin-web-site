...
> **Issue**: [KT-58587](https://youtrack.jetbrains.com/issue/KT-58587)
>
> **Component**: Core language
>
> **Incompatible change type**: source
...
> **Incompatible change type**: source
>
> **Short summary**: Kotlin 1.9.0 prohibits using the `enable` and `compatibility` modes of the `-Xjvm-default` compiler option
>
> **Deprecation cycle**:
>
