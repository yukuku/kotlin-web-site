...
### Prohibit super class constructor call on a function interface in supertypes list
...
> **Incompatible change type**: source
>
> **Short summary**: Kotlin 1.9 prohibits super class constructor calls on functional supertypes.
>
> **Deprecation cycle**:
> * 1.7.0: report a warning (or an error in progressive mode) on constructor calls on functional supertypes
> * 1.9.0: raise the warning to an error

### Prohibit cycles in annotations
...
> **Incompatible change type**: source
>
> **Short summary**: Kotlin 1.9 prohibits cycles in types of annotation parameters, unless the type is an `Array` or `vararg`.
>
> **Deprecation cycle**:
...
>  * 1.9.0: exception messages generated by expression null checks contain method or field names only


### Allow overriding open properties from inherited class
...
> **Incompatible change type**: behavioral
>
> **Short summary**: Prior to Kotlin 1.9, if you tried to override an open property from an inherited class, a compiler error is generated.
> This is fixed in Kotlin 1.9.
>
> **Deprecation cycle**:
>  * < 1.9.0: compiler error generated if overriding an open property from an inherited class
>  * 1.9.0: no compiler error generated
